...
import views.dialog.DialogCostumer;

public class InternalCostumer extends javax.swing.JInternalFrame {

    private int value;
    private Costumer cpf;
    private final impl.ImplCostumer crud;
    private final DefaultTableModel model;

    public InternalCostumer() {
        initComponents();
        crud = new ImplCostumer();
    ...
    private void cmdNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdNovoActionPerformed
        ...
        DialogCostumer dialog = new DialogCostumer(new JFrame(), true);
//        dialog.setTitle(this.getTitle());
    ...
    private void cmdDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdDeleteActionPerformed
        if (masterTable.getSelectedRow() != -1) {
            ...
            crud.delete(Costumer.class, value);
    ...
    private void editButton() {
        ...
        if (masterTable.getSelectedRow() != -1) {
            ...
            cpf = crud.find(Costumer.class, value);
            DialogCostumer dialog = new DialogCostumer(new JFrame(), true, cpf);
            dialog.setTitle(this.getTitle());
            dialog.setVisible(true);
