...
public class DialogCostumer extends javax.swing.JDialog {

    ImplCostumer crudPessoa;

    private Costumer cpf;

    private Costumer cancel;

    public DialogCostumer(java.awt.Frame parent, boolean modal) {

        super(parent, modal);

        this.cpf = new Costumer();
    ...
    public DialogCostumer(java.awt.Frame parent, boolean modal, Costumer cpf) {
    ...
    private void fields(Costumer cpf) {
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogCostumer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            ...
            DialogCostumer dialog = new DialogCostumer(new javax.swing.JFrame(), true);
