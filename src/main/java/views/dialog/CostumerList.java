...
public class CostumerList extends javax.swing.JDialog {
    ...
    public CostumerList(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private String tipoPessoa(Integer id) {
        String registro;
        ImplCostumer cpf = new ImplCostumer();
        Costumer pf = cpf.find(Costumer.class, id);
        if (pf == null) {
            ImplCompany cnpj = new ImplCompany();
            Company confirm = cnpj.find(Company.class, id);
            registro = confirm.getCnpjNumber();
        } else {

            registro = pf.getSocialNumber();
        }
    ...
    public static void main(String args[]) {
         try {
            ...
            java.util.logging.Logger.getLogger(CostumerList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
     
        java.awt.EventQueue.invokeLater(() -> {
            CostumerList dialog = new CostumerList(new javax.swing.JFrame(), true);
