...
public class DialogCategory extends javax.swing.JDialog {
    ...
    private void save() {
        try {
            ...
            categoria.setCategory(fieldCategoria.getText().toUpperCase());
    ...
    private void initComponents() {
        ...
        setIconImage(new ImageIcon(getClass().getResource("/img/categoria.png")).getImage());
        setModal(true);
    ...
    private void fields() {
        if (masterTable.getSelectedRow() != -1) {
            ...
            fieldCategoria.setText(categoria.getCategory());
        }
    }
