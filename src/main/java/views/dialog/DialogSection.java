...
public class DialogSection extends javax.swing.JDialog {

    private final DefaultTableModel model;
    private ProductSection secao;
    private ImplSection crud;

    private int value;

    public DialogSection(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void save() {
        try {
            ...
            secao.setSectionName(fieldCategoria.getText().toUpperCase());
    ...
    private void initComponents() {
        ...
        setTitle("CADASTRAR SEÇÃO");
        setIconImage(new ImageIcon(getClass().getResource("/img/secao.png")).getImage());
        setModal(true);
    ...
    private void cmdDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdDeleteActionPerformed
        ...
        if (masterTable.getSelectedRow() != -1) {
            ...
            crud.delete(ProductSection.class, value);
    ...
    private void fields() {
        if (masterTable.getSelectedRow() != -1) {
            ...
            int row = masterTable.getSelectedRow();
            this.modifRowTable(row);
            secao = crud.find(ProductSection.class, value);
            fieldCode.setText(String.valueOf(secao.getId()));
            fieldCategoria.setText(secao.getSectionName());
        }
    }
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(DialogSection.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        java.awt.EventQueue.invokeLater(() -> {
            DialogSection dialog = new DialogSection(new javax.swing.JFrame(), true);
