...
public class CustomerList extends javax.swing.JDialog {
    ...
    public CustomerList(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private String tipoPessoa(Integer id) {
        String registro;
        ImplCustomer cpf = new ImplCustomer();
        Customer pf = cpf.find(Customer.class, id);
        if (pf == null) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            CustomerList dialog = new CustomerList(new javax.swing.JFrame(), true);
