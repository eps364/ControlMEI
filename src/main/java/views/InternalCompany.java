...
import views.dialog.DialogCompany;

public class InternalCompany extends javax.swing.JInternalFrame {

    private int value;
    private final ImplCompany crud;
    private Company cnpj;
    private final DefaultTableModel model;

    public InternalCompany() {
        initComponents();
        crud = new ImplCompany();
    ...
    private void initComponents() {
        ...
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/img/cnpj.png"))); // NOI18N
    ...
    private void cmdNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdNovoActionPerformed
        ...
        DialogCompany dialog = new DialogCompany(new JFrame(), true);
//        dialog.setTitle(this.getTitle());
    ...
    private void cmdDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdDeleteActionPerformed
        if (masterTable.getSelectedRow() != -1) {
            ...
            crud.delete(Company.class, value);
    ...
    private void editButton() {
        ...
        if (row != -1) {
            ...
            cnpj = crud.find(Company.class, value);
            DialogCompany dialog = new DialogCompany(new JFrame(), true, cnpj);
            dialog.setTitle(this.getTitle());
            dialog.setVisible(true);
            updateTable();
            int size = crud.findAll().size();
