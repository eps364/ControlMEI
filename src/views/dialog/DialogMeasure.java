...
public class DialogMeasure extends javax.swing.JDialog {

    private final DefaultTableModel model;
    private Measure medida;
    private ImplMeasure crud;

    private int value;

    public DialogMeasure(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("CADASTRAR MEDIDA");
        setIconImage(new ImageIcon(getClass().getResource("/views/img/medida.png")).getImage());
        setModal(true);
    ...
    private void cmdDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdDeletarActionPerformed
        ...
        if (masterTable.getSelectedRow() != -1) {
            ...
            crud.delete(Measure.class, value);
    ...
    private void fields() {
        if (masterTable.getSelectedRow() != -1) {
            ...
            int row = masterTable.getSelectedRow();
            this.modifRowTable(row);
            medida = crud.find(Measure.class, value);
            fieldCode.setText(String.valueOf(medida.getId()));
            fieldCategoria.setText(medida.getMedida());
        }
    }
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(DialogMeasure.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        java.awt.EventQueue.invokeLater(() -> {
            DialogMeasure dialog = new DialogMeasure(new javax.swing.JFrame(), true);
