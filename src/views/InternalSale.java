...
import views.dialog.ClientList;
...
public class InternalSale extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        cmdBuscar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/query.png"))); // NOI18N
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/lupa.png"))); // NOI18N
        ...
        cmdAdicionar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/add16.png"))); // NOI18N
        ...
        cmdRemover.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/remove16.png"))); // NOI18N
        ...
        cmdConcluir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/confirm16.png"))); // NOI18N
        ...
        cmdSair.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/power16.png"))); // NOI18N
        ...
        cmdBuscar1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/query.png"))); // NOI18N
    ...
    private void cmdAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdAdicionarActionPerformed
        ...
        Stock s = estoque;
        s.setEstoqueQtd(Integer.parseInt(0 + fieldQtd.getText().replace(",", ".")));
        list.add(s);
    ...
    private void selectItem(Stock item) {
        try {
            ...
            fieldProduto.setText(item.getProdutoDescricao());
            fieldPreco.setText(String.valueOf(item.getPrecoVenda()).replace(".", ","));
            fieldCodicao.setText(item.getCondicao());
            fieldMarca.setText(item.getIdMarca().getMarca());
...
//        model.setRowCount(0);
        this.getListEstoque().forEach(l -> {
            model.addRow(new Object[]{
                l.getId(),
                l.getProdutoDescricao(),
                l.getEstoqueQtd(),
                l.getPrecoVenda(),
                l.getPrecoVenda().doubleValue() * l.getEstoqueQtd()
            });
