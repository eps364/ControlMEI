...
import views.dialog.DialogProduct;

public class InternalProduct extends javax.swing.JInternalFrame {

    private int value;
    private Stock produto;
    private final ImplProduct crud;
    ...
    private void updateTable() {
        ...
        crud.findAll().forEach(c -> {
            model.addRow(new Object[]{c.getId(),
                c.getProdutoDescricao(),
                new DecimalFormat("R$ #,##0.00").format(c.getPrecoVenda()),
                c.getEstoqueQtd(),
                c.getCondicao(),
                c.getIdMarca(),
                c.getPerson()
    ...
    private void initComponents() {
        ...
        setToolTipText("");
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/produto.png"))); // NOI18N
        ...
        masterTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "DESCRICAO", "PRECO", "QTD", "CONDIÇÃO", "MARCA", "CATEGORIA"
            }
        ) {
        ...
        if (masterTable.getColumnModel().getColumnCount() > 0) {
            ...
            masterTable.getColumnModel().getColumn(3).setMinWidth(40);
            masterTable.getColumnModel().getColumn(3).setPreferredWidth(50);
            masterTable.getColumnModel().getColumn(3).setMaxWidth(60);
        }
        ...
        cmdNovo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/save-pro.png"))); // NOI18N
        ...
        cmdEditar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/edit-pro.png"))); // NOI18N
        ...
        cmdDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/delete-pro.png"))); // NOI18N
        ...
        cmdSair.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/power.png"))); // NOI18N
    ...
    private void cmdNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdNovoActionPerformed
        ...
        DialogProduct dialog = new DialogProduct(new JFrame(), true);
//        dialog.setTitle(this.getTitle());
    ...
    private void editButton() {
        ...
        if (masterTable.getSelectedRow() != -1) {
            ...
            DialogProduct dialog = new DialogProduct(new JFrame(), true, produto);
            dialog.setTitle(this.getTitle());
            dialog.setVisible(true);
