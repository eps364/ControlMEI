...
import views.dialog.DialogCPF;

public class InternalCPF extends javax.swing.JInternalFrame {

    private int value;
    private Cpf cpf;
    private final impl.ImplCPF crud;
    ...
    private void initComponents() {
        ...
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/cpf.png"))); // NOI18N
    ...
    private void cmdNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdNovoActionPerformed
        ...
        DialogCPF dialog = new DialogCPF(new JFrame(), true);
//        dialog.setTitle(this.getTitle());
    ...
    private void editButton() {
        ...
        if (masterTable.getSelectedRow() != -1) {
            ...
            cpf = crud.find(Cpf.class, value);
            DialogCPF dialog = new DialogCPF(new JFrame(), true, cpf);
            dialog.setTitle(this.getTitle());
            dialog.setVisible(true);
