...
//        Configuration.Config();
    ...
    private void initComponents() {
        ...
        setIconImage(new ImageIcon(getClass().getResource("/views/img/icon.png")).getImage());

        fileMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/cadastrar.png"))); // NOI18N
        fileMenu.setMnemonic('f');
        fileMenu.setText("Cadastro de...");
        fileMenu.add(jSeparator2);

        jMenu2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/produto.png"))); // NOI18N
        ...
        itemCategoria.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/categoria.png"))); // NOI18N
        ...
        itemMarca.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/icon-marca.png"))); // NOI18N
        ...
        itemMedida.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/medida.png"))); // NOI18N
        ...
        itemProduto.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/produto.png"))); // NOI18N
        ...
        itemSecao.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/secao.png"))); // NOI18N
        ...
        jMenu1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/person.png"))); // NOI18N
        ...
        itemCPF.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/cpf.png"))); // NOI18N
        ...
        itemCNPJ.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/cnpj.png"))); // NOI18N
        ...
        itemFuncionario.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/employer.png"))); // NOI18N
        ...
        itemExit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/power.png"))); // NOI18N
        ...
        editMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/report.png"))); // NOI18N
        ...
        itemEntradaMercadoria.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/rigth.png"))); // NOI18N
        ...
        itemSaidaMercadoria.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/left.png"))); // NOI18N
        ...
        itemDespesa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/despesa.png"))); // NOI18N
        ...
        itemServico.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/services.png"))); // NOI18N
        ...
        helpMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/help.png"))); // NOI18N
        ...
        itemSistema.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/config.png"))); // NOI18N
        ...
        itemAjuda.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/img/help-item.png"))); // NOI18N
